...
1. WHEN пользователь выполняет команду init THEN Система SHALL создать файл .aa.yml в текущей директории
2. WHEN Система создает конфигурационный файл THEN Система SHALL заполнить его шаблоном с примерами полей
3. WHEN файл .aa.yml уже существует THEN Система SHALL завершиться с предупреждением без перезаписи файла
4. WHEN Система создает шаблон конфига THEN Система SHALL включить поля asana_token, interactive и список projects с примерами
